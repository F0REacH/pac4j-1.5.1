...
public class MailruOAuth20ServiceImpl extends OAuth20ServiceImpl {
    ...
    private String calculateSig(ParameterList parametersList, String apiSecret) {
...
//        }
        ...
        urlNew.append(apiSecret);
        //

        return md5Hex(urlNew.toString());
    }
    ...
    public void signRequest(Token accessToken, OAuthRequest request) {
        ParameterList parametersMap = null;
        ...
        if (request.getVerb() == Verb.GET) {
            ...
            if (request.getBodyParams().size() > 0) {
                ...
                if (request.getQueryStringParams().size() > 0) {
                    throw new UnsupportedOperationException("Ambiguous parameters passing - using both QueryStringParameters and BodyParameters.");
                }
            }
